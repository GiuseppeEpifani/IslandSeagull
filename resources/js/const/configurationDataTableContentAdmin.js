    ...
    "columns": [
        ...
        },
        {
            data: 'state', render: function (data, type, row) {
                return type === 'display' && data == 'desactivado' ?
                    '<button class="btn btn-success btn-sm btnActiveContent" title="Activar Contenido"">Activar</button>' : ' <div class="bg-primary text-white text-center rounded"> Activado</div>';
